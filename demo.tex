...
\titlecolor{white} % Choose between LUPink, LULBlue, LUIvory, LUGreen
\titleimage{\includegraphics[width=\paperwidth]{title.jpg}}
\thankscolor{white} % Choose between LUPink, LULBlue, LUIvory, LUGreen
\thanksimage{\includegraphics[width=\paperwidth]{cullen.jpg}}
%\titleimage{\includegraphics[scale=.6]{lumainb.jpg}}
\firstLogo{SEGlogo.png} % If not set, we would use SEGlogo.png 
%\secondLogo{Secondlogo.png} % If not set, the second logo would be left blank.
\author{Yuchen Jin}
