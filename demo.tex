...
\titlecolor{white} % Choose between UHRed, UHBlue, UHPink, UHLBlue, UHIvory, SEGNavy, SEGBlue, SEGRed, SEGYellow, SEGDBlue, SEGDGreen
\titleimage{\includegraphics[width=\paperwidth]{title.jpg}}
\thankscolor{white} % Choose between UHRed, UHBlue, UHPink, UHLBlue, UHIvory, SEGNavy, SEGBlue, SEGRed, SEGYellow, SEGDBlue, SEGDGreen
\thanksimage{\includegraphics[width=\paperwidth]{cullen.jpg}}
\firstLogo{seg-20-logo.pdf} % If not set, we would use SEGlogo.png 
%\secondLogo{seg-20-logo.pdf} % If not set, the second logo would be left blank.
\author{Yuchen Jin}
